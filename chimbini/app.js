...
function reveal() {
	...
	ifrm.setAttribute("src", "https://www.youtube.com/embed/Py0kfBExy4Y?enablejsapi=1");
	ifrm.width = w;
	ifrm.height = h;
	ifrm.style.border = 'none';
	ifrm.id = "youtube-video";
	document.querySelector('#video').appendChild(ifrm);
	// var ifrm = document.createElement("video");
	// ifrm.setAttribute("src", "https://www.youtube.com/watch?v=Py0kfBExy4Y");
	// ifrm.width = w;
	// ifrm.height = h;
	// ifrm.style.border = 'none';
	// ifrm.autoplay = true;
	// ifrm.muted = true; // Отключаем звук
	// ifrm.loop = true;
	// document.querySelector('#video').appendChild(ifrm);
